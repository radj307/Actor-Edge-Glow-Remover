...
{
    public class ParticleShaderSettings
    {
        public ParticleShaderSettings(uint startFrame = 0, uint startFrameVariation = 0, uint endFrame = 0, uint loopStartFrame = 0, uint loopStartVariation = 0, uint frameCount = 0, uint frameCountVariation = 0)
        {
